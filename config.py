...
LOG_GROUP = int(os.getenv("LOG_GROUP", "-1003033447583")) # optional with -100
FORCE_SUB = int(os.getenv("FORCE_SUB", "-1002944622554")) # optional with -100
...
ADMIN_CONTACT = os.getenv("ADMIN_CONTACT", "https://t.me/DebajaniSahoo9")
